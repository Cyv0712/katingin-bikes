...
const About = () => {
  return (
    <div className="about-page pb-5">
      <Helmet>
        <title>About Us | Trusted Big Bike Dealer Philippines | Katingin Bikes</title>
        <meta name="description" content="Discover Katingin Bikes. Learn about our roots, our commitment to transparency, verified 100-point mechanical inspection, and clean papers for pre-owned big bikes in the Philippines." />
        <meta property="og:title" content="About Us | Trusted Big Bike Dealer Philippines | Katingin Bikes" />
        <meta property="og:description" content="Discover Katingin Bikes: Our story, team, and commitment to delivering the highest quality pre-owned big bikes in Manila." />
